...
import { User, Listing, ListPhotos, UserListingSteps } from '../data/models';
...
const uploadListPhotoMobile = app => {
    ...
    app.post('/uploadListPhoto', function (req, res, next) {
        ...
        let files = req.files, listId = req.body.listId, requestHeader = req.headers;
        let isLoggedInUser, status = 200, errorMessage;
