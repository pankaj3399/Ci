...
class Itinerary extends React.Component {
  ...
  render() {
    ...
    if (data === null) {
      ...
      const { data, data: { startTime, endTime, listTitle, id, listId, checkIn, checkOut, total, guestServiceFee, currency, confirmationCode, reservationState, hostId, guestId, basePrice, delivery, discount, discountType, dayDifference } } = this.props;
