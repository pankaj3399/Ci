...
import { handleMobileSearchChange, handleMobileSelectSuggest } from '../../../helpers/GeoSuggest/updateSearchForm';
//Image
...
class SearchHeader extends Component {
  ...
  onSuggestSelect = (data, value) => {
    ...
    handleMobileSelectSuggest({ change, handleSubmit: this.handleClick, setPersonalizedValues, data, value });
  }

  onChangeSearch = async (value) => {
    const { setPersonalizedValues, change } = this.props;
    if (value == '') {
      handleMobileSearchChange({ change, handleSubmit: this.handleClick, setPersonalizedValues, value });
    }
  }
  ...
  renderPlacesSuggest = ({ input, label, containerClassName }) => {
    const { personalized } = this.props;
    return (
      <PlaceGeoSuggest
        placeholder={label}
          ...
          <div className={s.searchHeaderContainer}>
            {(verySmallDevice) && <Form>
              <Field
                ...
                containerClassName='mobileViewSearchHeader'
              />
            </Form>
            }
