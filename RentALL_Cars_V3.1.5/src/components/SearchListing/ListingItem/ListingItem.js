...
class ListingItem extends React.Component {
  ...
  render() {
    ...
    let bedsLabel, guestsLabel, heartIcon, transmissionLabel;
    bedsLabel = "Trip";
    guestsLabel = "guest";
    heartIcon = "heartIcon";
    if (beds > 1) {
    ...
    transmission == "1"
      ? (transmissionLabel = formatMessage(messages.Automatic))
      : (transmissionLabel = formatMessage(messages.Manuall));
    let personalizeURL = "",
      startDate,
      endDate,
      location;
    startDate = personalized?.startDate
      ? "?&startdate=" + personalized?.startDate
      : "";
    ...
    return (
      ...
      >
        ...
        <div className={s.listInfo}>
          <a
            className={s.listInfoLink}
            href={"/cars/" + formatURL(title) + "-" + id + personalizeURL}
            target={"_blank"}
          >
            <Row>
              <Col
              ...
              >
                ...
                >
                  ...
                  >
                    <img
                      src={bikeIcon}
                      className={cx("imgIconRight", s.bikeIcon)}
                    />
              ...
              >
                ...
                <div>
                  ...
                  <span className={cx(cs.fontWeightNormal, cs.commonSmallText)}>
              ...
              <div className={s.HRRight}>
                {starRatingValue > 0 && (
                  <div className={cx(s.reviewCss, "reviewCssSliderRTL")}>
                    <img
                      src={startIcon}
                      className={cx(s.reviewCssImg, "reviewCssImgRTL")}
                    />{" "}
                    {starRatingValue}
                  </div>
                )}
                ...
                >
                  ...
                  <img
                    src={arrowIcon}
                    className={cx(s.arrowIconCss, "viewArrowLeft")}
                  />
                </a>
              </div>
...
export default injectIntl(
  withStyles(s, cs)(connect(mapState, mapDispatch)(ListingItem))
);
